...
"Last-Translator: Atanas Stoev <atanas.stoev3@gmail.com>\n"
...
"enter it soon."
msgstr ""
"Изпратихме Ви код за потвърждение на %(email_link)s. Кода изтича скоро, моля "
"въведете го скоро."
...
msgstr "Ключ за влизане беше изпратен на %(email)s."
...
msgstr "Ще получите имейл съдържащ специален код за влизане без парола."
