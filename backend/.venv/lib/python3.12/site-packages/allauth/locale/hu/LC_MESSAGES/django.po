...
"up%(end_link)s first."
msgstr ""
"Ha még nem rendelkezel felhasználóval, akkor először "
"%(link)sregisztrálnod%(end_link)s kell."
...
msgstr "Van már felhasználód? Akkor %(link)sitt jelentkezz be%(end_link)s!"
...
#~ msgstr ""
#~ "Azért kaptad ezt a levelet, mert te vagy valaki más jelszócserét kért "
#~ "a(z) %(site_domain)s oldalon.\n"
#~ "Nyugodtan hagyd levelünket figyelmen kívül, ha nem te kérted. A jelszó "
#~ "cseréjéhez kövesd az alábbi linket."
